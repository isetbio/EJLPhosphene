...
% filenameRGC = 'mosaicAll_117391'; load(filenameRGC);
% filenameRGC = 'mosaicAll_547537.mat'; load(filenameRGC);
filenameRGC = 'mosaicAll_1087095.mat'; load(filenameRGC);
...
save(['C:\Users\James\Documents\MATLAB\github\EJLPhosphene\dat\tile\ws_dec3wnmaga_rs_' num2str(rsFactor) '_block' num2str(blockctr) '.mat'], 'innerRetina','movrecons_on_offHealthy');
toc
    end
end
...
% save(['C:\Users\James\Documents\MATLAB\github\EJLPhosphene\dat\dec3wn_movRecon_' num2str(rsFactor) '_1.mat'],'movieRecon');
