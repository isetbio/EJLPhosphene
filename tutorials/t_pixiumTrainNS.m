...
electrodeArray.width = 1*70e-6; % meters
...
os = osSet(os, 'rgbData', rand(96,96,2));
...
%     filename1 = [reconstructionRootPath '/dat/nsResponses/' saveFile '_block_' num2str(blockNum) '.mat'];
    filename1 = [reconstructionRootPath '/dat/pixium/' saveFile '_nsBig_100Hz_block_' num2str(blockNum) '.mat'];
