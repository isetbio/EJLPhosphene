...
os = osSet(os, 'rgbData', rand(100,100,2));
...
% if isempty(mosaicFile)
    ...
    paramsIR.eyeRadius = 1.5;        % Radius in mm
    ...
    filenameRGC = [phospheneRootPath '/dat/pixium15_100/' mosaicFile '.mat'];
...
%     filename1 = [reconstructionRootPath '/dat/nsResponses/' saveFile '_block_' num2str(blockNum) '.mat'];
    filename1 = [phospheneRootPath '/dat/pixium15_100/' saveFile '_nsBig15_100Hz_block_' num2str(blockNum) '_' mosaicFile '.mat'];
...
for ci = 1:25
    subplot(5,5,ci);
    imagesc(reshape(rfout(:,ci+cistart),[100 100]))
end
% 
% %%
% 
